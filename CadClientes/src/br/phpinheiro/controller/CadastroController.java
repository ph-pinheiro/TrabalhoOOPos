...
public class CadastroController {
	...
	public CadastroController(Result result, ClienteDAOFacade facadeCliente, DependenteDAOFacade facadeDependente) {
		this.result = result;
	...
	public void adicionarCliente(Cliente cliente, Dependente dependente1, Dependente dependente2) {
			...
			if(this.verificaClientePorCPF(cliente)){
				...
				this.result.redirectTo(CadastroController.class).form();
				return;
			} else{
		...
		this.result.redirectTo(CadastroController.class).list();
	}
